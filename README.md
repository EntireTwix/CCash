...
CCash solves these issues and adds a level of abstraction, the main idealogical guideline of CCash is to have fast core operations that other services that build on top of this abstraction
