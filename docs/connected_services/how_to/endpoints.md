...
| ApiProperties      | properties of the given instance                                               | `N/A`                          | api/v1/properties              |    `GET`    |      200       | json object | {"version":uint64,"max_log":uint64} and "return_on_del":string if feature is enabled |    :heavy_check_mark:    | :heavy_multiplication_x: | :heavy_multiplication_x: | :heavy_multiplication_x: |

{"version":uint64,"max_log":uint64,"return_on_del":}
